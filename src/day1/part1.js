...
function calculateMinimumDistanceFromInstructions(instructions) {
    ...
    var stepsEast = parsedInstructions.reduce(function (acc, instruction) {
    ...
    var stepsNorth = parsedInstructions.reduce(function (acc, instruction) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    distance = calculateMinimumDistanceFromInstructions(instructions);
